        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                IconButton(
                  icon: FaIcon(FontAwesomeIcons.facebook), // Use FaIcon from font_awesome_flutter
                  onPressed: () {
                    // Navigate to Facebook profile
                  },
                ),
                IconButton(
                  icon: FaIcon(FontAwesomeIcons.twitter), // Use FaIcon from font_awesome_flutter
                  onPressed: () {
                    // Navigate to Twitter profile
                  },
                ),
                IconButton(
                  icon: FaIcon(FontAwesomeIcons.linkedin), // Use FaIcon from font_awesome_flutter
                  onPressed: () {
